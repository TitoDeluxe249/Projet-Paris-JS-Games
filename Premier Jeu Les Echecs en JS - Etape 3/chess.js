...
function coloring() {
    ...
    color.forEach(color => {
        ...
        if (a % 2 !== 0) {
            color.style.backgroundColor = 'rgb(216, 181, 137)'
        }
...
// Initialisation des points à zéro
let score = 0;
...
// Exemple d'utilisation : ajouter 10 points
ajouterPoints(10);
...
// Récupérer le score depuis le localStorage
